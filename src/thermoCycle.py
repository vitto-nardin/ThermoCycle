...
# from the 'equipment' directory. This allows the ThermoCycle class to recognize and interact
...
class ThermoCycle(): # Defines the ThermoCycle class without inheriting any other class.
    def __init__(self): # Constructor of the ThermoCycle class without any arguments other than 'self'.

        self.equipments = [] # Initializes an empty list for the equipment of the ThermoCycle
        self.connectors = [] # Initializes an empty list for the connectors of the ThermoCycle
    ...
    def calculate_efficiency(self): # This method calculates the efficiency of the thermodynamic cycle. Efficiency is typically defined as (Net Work Generated) / (Heat Added).
        ...
        for equipment in self.equipments: # Iterates over each equipment to sum the work and heat.
            if isinstance(equipment, Turbine): # If the equipment is a Turbine (which generates positive work):
