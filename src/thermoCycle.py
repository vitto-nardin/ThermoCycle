...
# do diretório 'equipment'. Isso permite que a classe ThermoCycle reconheça e interaja
...
class ThermoCycle(): # Define a classe ThermoCycle sem herdar nenhuma outra classe.
    def __init__(self): # Construtor da classe ThermoCycle sem nenhum argumento além do 'self'.

        self.equipments = [] # Inicializa uma lista vazia para os equipamentos do ThermoCycle
        self.connectors = [] # Inicializa uma lista vazia para os conectores do ThermoCycle
